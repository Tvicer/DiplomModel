...
Original file is located at
    https://colab.research.google.com/drive/1WrdXNG9b7tWPvWUo4hXH3URL4WFnmNA_
...
df_cor_all = pd.concat([df_cor_all, df_cor], axis=1)
df_cor_all
...
df_cor = create_attrs(df['tell'].sample(n=50), (semantic_components_full, semantic_components_entities, semantic_components_actions)).iloc[:, 1:]
df_cor['tell_time'] = df['tell_time']
plt.figure(figsize=(10,5))
sns.heatmap(df_cor.corr(), annot = True, vmin=-1, vmax=1, center= 0)
# df_cor
...
df_cor[["tell_time"]] = df_cor[["tell_time"]].astype(str)
df_cor['tell_time'] = df_cor['tell_time'].map(lambda s: re.sub('\D', '', s))
df_cor = df_cor[df_cor.tell_time != '']
scaler = preprocessing.StandardScaler().fit(df_cor)
df_scaled = scaler.transform(df_cor)
